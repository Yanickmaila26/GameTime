...
import { Users, UserCheck, Trophy, Swords, Sparkles, ShieldCheck } from 'lucide-react'

export default function Dashboard({ stats, liveMatches }) {
      ...
      <div className="space-y-6">
        ...
        <div className="bg-[#0d0d0d] border border-[#1a1a1a] rounded-3xl p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <Link href="/admin/equipos" className="p-4 bg-[#121212] hover:bg-[#161616] border border-[#222] rounded-2xl flex flex-col items-center space-y-2 group transition-all">
            ...
            <Link href="/admin/campeonatos" className="p-4 bg-[#121212] hover:bg-[#161616] border border-[#222] rounded-2xl flex flex-col items-center space-y-2 group transition-all">
              <div className="w-10 h-10 bg-orange-500/10 rounded-xl flex items-center justify-center group-hover:bg-orange-500/20">
                <Trophy className="w-5 h-5 text-[#F57C00]" />
              </div>
              <span className="text-xs font-bold text-white">Campeonatos</span>
            </Link>
            <Link href="/admin/partidos" className="p-4 bg-[#121212] hover:bg-[#161616] border border-[#222] rounded-2xl flex flex-col items-center space-y-2 group transition-all">
              <div className="w-10 h-10 bg-orange-500/10 rounded-xl flex items-center justify-center group-hover:bg-orange-500/20">
