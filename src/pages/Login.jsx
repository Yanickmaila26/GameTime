...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#070707] text-gray-100 flex items-center justify-center p-4 relative overflow-hidden">
      {/* Background gradients for WOW premium factor */}
      ...
      <div className="w-full max-w-md bg-gradient-to-b from-[#121212] to-[#0a0a0a] border border-[#1e1e1e] p-8 rounded-3xl shadow-2xl relative z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="w-16 h-16 bg-gradient-to-tr from-orange-500 to-amber-600 rounded-2xl flex items-center justify-center shadow-[0_8px_20px_rgba(245,124,0,0.3)] border border-orange-400 mb-3 animate-pulse">
            <span className="text-white font-black text-2xl tracking-tighter">GT</span>
          </div>
          <span className="inline-flex items-center space-x-1 bg-orange-500/10 border border-orange-500/20 text-[10px] font-black text-[#F57C00] px-2.5 py-0.5 rounded-full uppercase tracking-wider mb-2">
